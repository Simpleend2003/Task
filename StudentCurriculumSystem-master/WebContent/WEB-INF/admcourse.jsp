	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="AdmStudent"> <i class="menu-icon fa fa-table"></i> <span class="menu-text">
							维护学生信息 </span>
					</a> <b class="arrow"></b>
				<li class="active"><a href="AdmCourse"> <i class="menu-icon fa fa-map-marker"></i> <span class="menu-text">
							维护课程 </span>
					</a> <b class="arrow"></b>
						...
						<table id="dynamic-table"
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div>
											<form class="no-padding" action="AdmCDelete" method="post"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body no-padding">
						<tr class="detail-row">
							<form class="form-horizontal" role="form" action="AdmCAdd"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="学时" class="col-xs-8"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
									<input type="radio" name="testway" value="考试" checked="true" />考试 <input
											type="radio" name="testway" value="考查" />考查
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="学分" class="col-xs-8"
											required="required" name="credit"
											 />
									</div>
								</div>
		...
		<div id="row<%=i%>" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body no-padding">
						<tr class="detail-row">
							<form class="form-horizontal" role="form" action="AdmCChange"
								method="POST" accept-charset="UTF-8">
								<div class="space-6"></div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="课程编号" class="col-xs-8"
											required="required" name="num"
											value="<%=cList.get(i).getCoursenum()%>" readonly="readonly" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="课程名称姓名" class="col-xs-8"
											required="required" name="name"
											value="<%=cList.get(i).getCoursename()%>" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<%
											if (cList.get(i).getTestway().equals("考试")) {
										%>
										<input type="radio" name="testway" value="考试" checked="true" />考试 <input
											type="radio" name="testway" value="考查" />考查
										<%
										...
										%>
										<input type="radio" name="testway" value="考试" />考试 <input
											type="radio" name="testway" value="考查"   checked="true"/>考查
										<%
											}
										%>
									</div>
